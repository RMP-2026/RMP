...
import { getCompanyById, MOCK_THREADS } from "../../../lib/mock-data";
            ...
            renderItem={({ item }) => {
              ...
              return (
                ...
                >
                  <View>
                    <Image
                      source={{ uri: company?.avatarUrl ?? COMPANY_AVATAR }}
                      contentFit="cover"
                  ...
                  <View className="flex-1">
                    <Text className="text-body-md font-bold text-ink">{company?.name ?? "Unknown company"}</Text>
